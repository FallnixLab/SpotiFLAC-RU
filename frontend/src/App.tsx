                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription className="space-y-3">
                            <span className="block">
                                Не удалось получить метаданные. Попробуйте использовать качественный VPN, такой как 
                                Surfshark, ExpressVPN, Proton VPN, или аналогичный сервис.
                            </span>
                            <span className="block">
                                Выберите локацию, которая не заблокирована Spotify или связанными
                                сервисами, например: США, Великобритания, Германия, Нидерланды,
                                или Сингапур.
                            </span>
                            <span className="block">
                ...
                <DialogContent className="max-w-[450px] [&>button]:hidden p-6 gap-5">
                    <DialogHeader className="space-y-2">
                        ...
                        <DialogDescription className="text-sm text-foreground/70 leading-relaxed font-normal">
                            SpotiFLAC сначала проверяет вашу систему на наличие FFmpeg и FFprobe.
