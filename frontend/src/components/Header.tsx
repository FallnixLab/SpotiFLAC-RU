  ...
  return (<div className="relative">
    <div className="text-center space-y-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge variant="default" asChild>
                <button type="button" onClick={() => openExternal("https://github.com/FallnixLab/SpotiFLAC-RU/releases")} className="cursor-pointer hover:opacity-80 transition-opacity">
                  v{version}
                </button>
              </Badge>
            </TooltipTrigger>
      ...
      <p className="text-muted-foreground">
        Скачивай треки Spotify в настоящем FLAC с Tidal, Qobuz и Amazon Music — без аккаунтов.
      </p>
    </div>
  </div>);
}
