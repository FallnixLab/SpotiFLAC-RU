...
export function HistoryPage({ onHistorySelect }: HistoryPageProps) {
    ...
    const getTrackLink = (spotifyId: string) => {
        ...
        if (spotifyId?.startsWith("amazon_"))
            return { url: `https://music.amazon.com/tracks/${spotifyId.replace("amazon_", "")}`, label: "Открыть в Amazon Music" };
                     ...
                     <div className="flex items-center gap-2">
                        ...
                        <Select value={downloadSortBy} onValueChange={setDownloadSortBy}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="date_desc">Дата (Сначала новые)</SelectItem>
                                <SelectItem value="date_asc">Дата (Сначала старые)</SelectItem>
                                <SelectItem value="title_asc">Название (А-Я)</SelectItem>
                                <SelectItem value="title_desc">Название (Я-А)</SelectItem>
                                <SelectItem value="artist_asc">Исполнитель (А-Я)</SelectItem>
                            ...
                            <div className="space-y-1">
                             ...
                             <thead>
                                <tr className="border-b bg-muted/50">
                                    ...
                                    <th className="h-10 px-4 text-left align-middle font-medium text-muted-foreground hidden xl:table-cell w-16 text-xs uppercase text-nowrap">Длит.</th>
                ...
                <DialogContent className="max-w-md [&>button]:hidden">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Примечание: Сами скачанные файлы НЕ будут удалены.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
