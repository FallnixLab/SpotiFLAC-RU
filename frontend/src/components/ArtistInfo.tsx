        ...
        try {
            ...
            if (response.success) {
                if (response.already_exists) {
                    ...
                    toast.success("Шапка успешно скачана");
                }
            }
            else {
        ...
        try {
            ...
            if (response.success) {
                if (response.already_exists) {
                    ...
                    toast.success("Аватар успешно скачан");
                }
            }
            else {
        ...
        try {
            ...
            if (response.success) {
                if (response.already_exists) {
                    ...
                    toast.success(`Изображение галереи ${index + 1} успешно скачано`);
                }
            }
            else {
        ...
        try {
            ...
            if (failCount === 0) {
                if (existsCount > 0 && successCount > 0) {
                    ...
                    toast.success(`Все ${successCount} изображений галереи успешно скачаны`);
                }
            }
            else {
